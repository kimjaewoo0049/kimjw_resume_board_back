...
public class SecruityConfig {
    ...
    public SecurityFilterChain filterChain (HttpSecurity http)throws Exception{
        ...
        http.authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(HttpMethod.GET,"/content-view").permitAll()
                ...
                .requestMatchers(HttpMethod.PUT,"/content-update").hasAnyAuthority("USER")
                .requestMatchers(HttpMethod.POST,"/content-create").hasAnyAuthority("USER")
                .requestMatchers(HttpMethod.DELETE,"/content-delete").hasAnyAuthority("USER")
